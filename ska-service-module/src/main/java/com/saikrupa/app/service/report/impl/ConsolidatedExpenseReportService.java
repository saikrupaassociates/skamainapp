...
public class ConsolidatedExpenseReportService extends AbstractReportService {
	
	private List<ExpenseData> expenses;

	public ConsolidatedExpenseReportService(List<ExpenseData> expenses) {
	...
	public String getPageTitle() {
		return "Expense Report - Consolidated";
	}
