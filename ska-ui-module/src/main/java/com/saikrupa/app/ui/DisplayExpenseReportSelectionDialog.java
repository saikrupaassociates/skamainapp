...
public class DisplayExpenseReportSelectionDialog extends BaseAppDialog {
		...
		ActionListener l = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if ("CONSOLIDATED".equalsIgnoreCase(e.getActionCommand())) {
					...
					DisplayVendorListDialog d = new DisplayVendorListDialog(DisplayExpenseReportSelectionDialog.this);
					d.setVisible(true);
